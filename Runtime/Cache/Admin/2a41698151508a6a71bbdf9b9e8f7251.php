...
{
  text-align:center;
	background:url(<?php echo APP_TMPL_PATH;?>skin/images/frame/topitembg.gif) 0px 3px no-repeat;
	width:82px;
	height:26px;
	line-height:28px;
}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="<?php echo APP_TMPL_PATH;?>skin/images/frame/topbg.gif">
  <tr>
    <td width='20%' height="60"><img src="<?php echo APP_TMPL_PATH;?>skin/images/frame/logo.gif" /></td>
