...
<title><?php echo C('APP_WEBSITE');?>网站管理后台</title>
<script type="text/javascript" src="<?php echo APP_TMPL_PATH;?>skin/js/common.js"></script>
<link rel="stylesheet" href="<?php echo APP_TMPL_PATH;?>skin/css/login.css" type="text/css" media="all" />
...
<div class="main">
  <div class="login">
    <form name="myform" action="__URL__/checkLogin" method="post" >
      ...
      <div class="butbox">
        <dl>
          <dt><img src="__IMG__/Admin/logo_1.png" alt="<?php echo C('APP_WEBSITE')?>" /></dt>
          <dd style="padding-left:50px;"><?php echo C('APP_WEBSITE');?></dd>
        </dl>
      </div>
